                    ...
                    <div key={index}>
                        {item?.main_content !== null && <div className="my-2 grid grid-cols-12">
                            {item?.main_content?.api_key && item?.main_content?.list_id && (
                                <div className="col-span-12 bg-white w-full rounded-md flex gap-6 flex-col items-center justify-center p-2">
                                    <label className="text-[24px] leading-[36px] font-semibold text-black pt-6">Hello There!!!</label>
                                    <label className="text-[14px] leading-[18px] text-black">You can subscribe to our community here by entering your email below and pressing enter.
                                    </label>
                                        ...
                                        className="w-full  h-full text-black border-gray-200 border-[0.5px] p-2 rounded-lg" />
                                    {
                                        mail_chimp_loading ? (<div className="flex items-center justify-center my-2" >
                                            ...
                                            <div className="animate-spin inline-block w-6 h-6 border-[3px] border-current border-t-transparent 
                                             rounded-full text-blue-500" role="status" aria-label="loading">
                                            </div>
